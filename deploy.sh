...
# main config
PLUGINSLUG="github-theme-updater"
CURRENTDIR=`pwd`
MAINFILE="github-theme-updater.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/github-theme-updater" # Remote SVN repo on wordpress.org, with no trailing slash
